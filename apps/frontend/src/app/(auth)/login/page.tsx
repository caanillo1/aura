      ...
      >
        ...
        >
          ...
          <Link href="/buscar-firmas">
            <motion.div
              whileHover={{ scale: 1.01, boxShadow: '0 4px 24px rgba(52,211,153,0.25)' }}
              whileTap={{ scale: 0.99 }}
              className="w-full rounded-lg py-2.5 text-sm font-semibold text-center cursor-pointer flex items-center justify-center gap-2 transition-all"
              style={{

...
export const serviceOrdersApi = {
  ...
  addNote: (id: string, note: string, noteType: string, noteLevel: string, noteSubtype?: string, noteMitigation?: string) =>
    api.post(`/service-orders/${id}/notes`, { note, noteType, noteLevel, noteSubtype, noteMitigation }).then((r) => r.data),
